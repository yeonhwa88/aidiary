...
<body>
	<table>
		...
		<tr>
			<th>등록</th>
			<td><fmt:formatDate value ="${person.rdate }" pattern="YY-MM-dd(E) hh:mm(a)"/></td>
		</tr>
		<tr>
			<td colspan="2">
				<button onclick="location='${conPath }/update.do?id=${person.id }&pageNum=${param.pageNum }'">수정</button>
				<button onclick="location='${conPath }/update2.do?id=${person.id }&pageNum=${param.pageNum }'">수정2</button>				
